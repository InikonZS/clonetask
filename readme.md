...
- Можно придумать свой вариант, подробно описать, указать прототип.
- Это может быть приложение, наподобие графический редактор вроде [Autodesk Tinkercad](https://www.tinkercad.com/), Figma, Photopea и другие.
